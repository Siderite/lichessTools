  ...
  class ShowFlagsTool extends LiChessTools.Tools.ToolBase {
    ...
    getElementsForFlag = () => {
      ...
      $.cached('.user-link,a[href^="/@/"]', 2000).each((i, e) => {
        if ($(e).closest('#friend_box,.lichessTools-onlineFriends,div.complete-list,.crosstable__users,div.chat__members,#dasher_app,.lichessTools-challengeOptions,#topnav,.advice-summary__player,.simul-list__content').length) return;
