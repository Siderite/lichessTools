	...
	class StudyLearnFromMistakesTool extends LiChessTools.Tools.ToolBase {
		...
		intl = {
			...
			"ro-RO": {
				...
				"options.studyLearnFromMistakes":
					"\u00CEnva\u0163\u0103 din gre\u015Feli \u00een Studii",
				...
				findBetterMoveForWhite:
					"G\u0103se\u015Fte o mutare mai bun\u0103 pentru albe",
				findBetterMoveForBlack:
					"G\u0103se\u015Fte o mutare mai bun\u0103 pentru negre",
				resumeLearning: "Reia \u00eenv\u0103\u0163atul",
				youCanDoBetter: "Po\u0163i mai bine",
				tryAnotherMoveForWhite:
					"\u00CEncearc\u0103 alt\u0103 mutare pentru albe",
				tryAnotherMoveForBlack:
					"\u00CEncearc\u0103 alt\u0103 mutare pentru negre",
				solution: "Solu\u0163ie",
				waitingForAnalysis: "A\u015Ftept\u00e2nd analiza",
				noMistakesFoundForWhite:
					"Nici o gre\u015Feal\u0103 g\u0103sit\u0103 din partea albelor",
				noMistakesFoundForBlack:
					"Nici o gre\u015Feal\u0103 g\u0103sit\u0103 din partea negrelor",
				doneReviewingWhiteMistakes:
					"Gata cu analiza gre\u015Felilor din partea albelor",
				doneReviewingBlackMistakes:
					"Gata cu analiza gre\u015Felilor din partea negrelor",
		...
		toggleRetro = () => {
			...
			analysis.mainline.forEach((n) => {
				...
				const comment = n.children
					.flatMap((ch) => ch.comments || [])
					.find((c) => c.by == "lichess")?.text;
				if (!comment) return;
