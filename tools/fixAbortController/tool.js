(() => {
	class FixAbortControllerTool extends LiChessTools.Tools.ToolBase {
		...
		async init() {
			...
			parent.global.AbortController.prototype.abort = parent.wrapFunction(
				parent.global.AbortController.prototype.abort,
				{
		...
		async start() {
			...
			parent.global.AbortController.prototype.abort = parent.unwrapFunction(
				parent.global.AbortController.prototype.abort,
				"fixAbortController",
			);
			if (!value) return;
