(() => {
	class PreviousGameMenuTool extends LiChessTools.Tools.ToolBase {
		...
		intl = {
			...
			"ro-RO": {
				"options.TV": "TV",
				"options.previousGameMenu":
					"Op\u0163iune de meniu pentru ultimul joc vizionat",
		...
		async start() {
			...
			const container = $(
				'#topnav section a[href="/tv"]+div[role="group"],#topnav section a[href="/broadcast"]+div[role="group"]',
			);
