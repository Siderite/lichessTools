(() => {
	class TranspositionBehaviorTool extends LiChessTools.Tools.ToolBase {
		...
		intl = {
			"en-US": {
				"options.study": "Study",
				"options.transpositionBehavior":
					"Behavior/definition of transpositions",
				"transpositionBehavior.excludeSameLine": "Exclude if in the same line",
				"transpositionBehavior.consideredVariations":
					"Play moves from transpositions",
				"transpositionBehavior.groupSameMove": "Don't add identical next moves",
			},
			"ro-RO": {
				"options.study": "Studiu",
				"options.transpositionBehavior":
					"Comportament/defini\u0163ie a transpozi\u0163iilor",
				"transpositionBehavior.excludeSameLine":
					"Exclude dac\u0103 \u00een aceea\u015Fi varia\u0163iune",
				"transpositionBehavior.consideredVariations":
					"Joac\u0103 mut\u0103ri de la transpozi\u0163ii",
				"transpositionBehavior.groupSameMove":
					"Nu ad\u0103uga mut\u0103ri identice",
			},
		};
